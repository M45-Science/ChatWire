...
func DoQuickLatest(force bool) (*InfoData, string, bool, bool) {
	return doQuickLatest(force, true)
}

func DoQuickLatestSilent(force bool) (*InfoData, string, bool, bool) {
	return doQuickLatest(force, false)
}
...
func doQuickLatest(force bool, reportDiscord bool) (*InfoData, string, bool, bool) {
	...
	if force {
		...
		err = fullPackage(info, reportDiscord)
		if err != nil {
			if reportDiscord {
