...
func RegisterCommands() {
	...
	CL.CommandList = append(CL.CommandList, Command{Name: "Reboot", Command: admin.Reload, Admin: true, Help: "Reboots bot & Factorio"})
	...
	CL.CommandList = append(CL.CommandList, Command{Name: "ForceReboot", Command: admin.Reboot, Admin: true, Help: "Force close bot, don't use this."})
